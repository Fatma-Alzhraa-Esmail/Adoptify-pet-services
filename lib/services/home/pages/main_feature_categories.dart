                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        maniCategory.main_feature_name==FeatureType.Shop.name?
                        ProductsListWidget(
                            mainFeatureCategoriesCubit:
                                mainFeatureCategoriesCubit):
                        ServiceListWidget(mainFeatureCategoriesCubit: mainFeatureCategoriesCubit)

                        // :
                        // ServicesListWidget(item: mainFeatureCategoriesCubit),
                      ],
                    ),
                  ),
                );
