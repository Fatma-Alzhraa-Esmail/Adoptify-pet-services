...
Widget drawSvgIconColored(String iconName,{double? width,double? height,Color? iconColor}) => SizedBox(width: width??24,height:height ??24,child: SvgPicture.asset("assets/icons/svg/$iconName.svg"));